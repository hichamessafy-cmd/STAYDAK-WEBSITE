-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('SUPER_ADMIN', 'CLINIC_ADMIN', 'DOCTOR', 'SECRETARY', 'PATIENT');
...
-- CreateEnum
CREATE TYPE "MedicineForm" AS ENUM ('TABLET', 'CAPSULE', 'SYRUP', 'INJECTION', 'OINTMENT', 'DROPS', 'INHALER', 'OTHER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('APPOINTMENT_REMINDER', 'APPOINTMENT_CONFIRMED', 'APPOINTMENT_CANCELLED', 'PRESCRIPTION_READY', 'INVOICE_ISSUED', 'PAYMENT_RECEIVED', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "Secretary_clinicId_idx" ON "Secretary"("clinicId");
...
-- AddForeignKey
ALTER TABLE "Secretary" ADD CONSTRAINT "Secretary_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_scheduledById_fkey" FOREIGN KEY ("scheduledById") REFERENCES "Secretary"("id") ON DELETE SET NULL ON UPDATE CASCADE;
